...
public:
    ...
    TalkcoinAmountField *transactionFee;
    QSpacerItem *horizontalSpacer_1_Main;
    QCheckBox *talkcoinAtStartup;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        transactionFee = new TalkcoinAmountField(tabMain);
        ...
        talkcoinAtStartup = new QCheckBox(tabMain);
        talkcoinAtStartup->setObjectName(QString::fromUtf8("talkcoinAtStartup"));

        verticalLayout_Main->addWidget(talkcoinAtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        talkcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Talkcoin after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        talkcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Talkcoin on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Talkcoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Talkcoin network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Talkcoin.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show Talkcoin addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
